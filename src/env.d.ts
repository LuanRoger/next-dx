...
type _CoercedEnvSchema_edfbadcc = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_edfbadcc> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_edfbadcc, 'JSON_PLACEHOLDER_URL'>> {}
}
...
type _EnvSchemaAsStrings_edfbadcc = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_edfbadcc {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_edfbadcc {}
  }
}